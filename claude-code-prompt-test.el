;;; test-claude-code-prompt.el --- Tests for prompt file functionality -*- lexical-binding: t; -*-
...
;; Test suite for claude-code-prompt module
...
(ert-deftest test-claude-code-open-prompt-file ()
  "Test prompt file creation and opening."
  (with-claude-test-project
   (let* ((prompt-file (expand-file-name ".claude-code.prompt.md" temp-dir))
     ...
     (should (eq major-mode 'claude-code-prompt-mode))

     ;; Clean up
     (let ((kill-buffer-query-functions nil))
       (kill-buffer (current-buffer))))))

(ert-deftest test-claude-code-get-markdown-section-at-point ()
  ...
  (with-temp-buffer
    ...
    ;; Test at heading
    (goto-char (point-min))
    (let ((section (claude-code-get-markdown-section-at-point)))
...
(ert-deftest test-claude-code-prompt-mode ()
  ...
  (with-temp-buffer
    ...
    ;; Test keybindings
    (should (eq (lookup-key claude-code-prompt-mode-map (kbd "C-c C-s"))
                'claude-code-send-prompt-at-point))
    (should (eq (lookup-key claude-code-prompt-mode-map (kbd "C-c C-r"))
                'claude-code-send-prompt-region))
    (should (eq (lookup-key claude-code-prompt-mode-map (kbd "C-c C-o"))
                'claude-code-run))
    (should (eq (lookup-key claude-code-prompt-mode-map (kbd "C-c C-t"))
                'claude-code-prompt-transient))))

(ert-deftest test-claude-code-insert-region-path-to-prompt ()
  "Test inserting region path to prompt buffer."
  (let ((test-file "/home/user/project/src/main.el")
        (prompt-file "/home/user/project/.claude-code.prompt.md")
    ...
    (with-temp-buffer
      ...
      (cl-letf* (((symbol-function 'projectile-project-root)
                 ...
                 ((symbol-function 'claude-code-open-prompt-file)
                  (lambda ()
        ...
        ;; Call the function
        (claude-code-insert-region-path-to-prompt)
...
(ert-deftest test-claude-code-insert-region-path-to-prompt-with-trailing-newline ()
...
(ert-deftest test-claude-code-insert-current-file-path-to-prompt ()
  ...
  (let ((test-file "/home/user/project/docs/MCP-SETUP.md")
    ...
    (with-temp-buffer
      ...
      (cl-letf* (((symbol-function 'projectile-project-root)
        ...
        ;; Call the function
        (claude-code-insert-current-file-path-to-prompt)
...
(ert-deftest test-claude-code-insert-current-file-path-to-prompt-with-region ()
...
(ert-deftest test-claude-code-insert-current-file-path-to-prompt-with-region-ending-newline ()
...
(ert-deftest test-claude-code-insert-current-file-path-to-prompt-with-single-line-region ()
...
(ert-deftest test-claude-code-insert-region-path-to-prompt-single-line ()
...
(ert-deftest test-claude-code-insert-current-file-path-to-session ()
...
(ert-deftest test-claude-code-insert-current-file-path-to-session-with-region ()
...
(ert-deftest test-claude-code-insert-current-file-path-to-session-single-line ()
...
(provide 'test-claude-code-prompt)
;;; test-claude-code-prompt.el ends here
